		...
		<>
			<div className="office-outer-container">
				...
				<div className="office-internal-pics">
					<img src={IMAGES.office1} loading="lazy" alt="office1" />
					<img src={IMAGES.office2} loading="lazy" alt="office2" />
					<img src={IMAGES.office3} loading="lazy" alt="office3" />
					<img src={IMAGES.office4} loading="lazy" alt="office4" />
				</div>
